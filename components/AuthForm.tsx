            ...
            >
                ...
                {type === "sign-up" && (
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <div className="p-4 shadow-1 border border-n-7 rounded-xl flex flex-col gap-[6px]">
                                    ...
                                    <FormControl>
                                        <Input
                                            ...
                                            {...field}
                                            className="p-0 border-none shadow-none subtitle-2 placeholder:text-n-6 text-n-6"
                                        />
                                    </FormControl>
                                </div>
                ...
                <Button
                    type="submit"
                    className="h-auto py-6 bg-n-1 hover:bg-n-2 rounded-full"
                    disabled={isLoading}
                >
