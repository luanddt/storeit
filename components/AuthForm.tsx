            ...
            >
                ...
                {type === "sign-up" && (
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <div className="p-4 border border-light-300 rounded-xl shadow-1 space-y-[6px]">
                ...
                <Button
                    type="submit"
                    className="h-auto py-6 bg-brand hover:bg-brand-100 !shadow-2 rounded-full transition-all"
                    disabled={isLoading}
                >
                ...
                {errorMessage && (
                    <p className="mx-auto px-8 py-4 bg-error/5 rounded-xl body-2 text-error">
                        *{errorMessage}
                    </p>
                )}
