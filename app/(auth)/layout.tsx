...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
    return (
        <div className="min-h-screen flex">
            <section className="xl:w-2/5 w-1/2 p-10 bg-n-1 lg:flex hidden justify-center items-center">
            ...
            <section className="lg:px-10 px-4 lg:py-0 py-10 bg-white flex flex-[1] flex-col lg:justify-center items-center gap-16">
                <Image
